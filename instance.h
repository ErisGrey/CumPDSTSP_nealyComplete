...
public:
    ...
    vector<int> min_drones_required;
    vector<int> max_drones_allowed;
    vector<double> weight;
    vector<vector<double>> dist_drone, dist_truck;
    vector<vector<double>> time_truck;
    vector<DroneConfig> droneConfigs;
    ...
    double tdrone(const int& dconfig, const int& customer) const;
    double ttruck(int i, int j);
    double dtruck(int i, int j);
    double serviceTime_drone(const int& dconfig, const int& customer) const;
